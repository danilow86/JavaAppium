...
public class LoginPage extends BasePage {
	...
	public void enterPassword(String _password) {
		...
		sendKeys(By.xpath(LoginPageObject.passwordField_xpath)," "+_password, 40," "+_password);
		//driver.hideKeyboard();
	}

	public void clickOtherLoginButton() {
		click(By.xpath(LoginPageObject.OtherLoginButton_xpath),"Click on login button",0);
		pause(20);
	}
