...
public class TestCore extends Page {
	...
	public void fetchSuiteConfiguration(ITestContext testContext) throws IOException, InterruptedException, MalformedURLException {
		...
		if (os.toLowerCase().contains("android")) {
			...
			cap.setCapability(MobileCapabilityType.APP,System.getProperty("user.dir")+"//src//main//resources//app//cybrary.apk");
			cap.setCapability("autoGrantPermissions", true);
			cap.setCapability("appActivity","md579b83d02395fe328fa80f34ea0dc7985.SplashActivity");
			cap.setCapability("appPackage","com.cybrary.cybrary");
		...
		///Caso utilize configurações para o IOS XCode
